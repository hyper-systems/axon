...
class MCP342x(object):
    ...
    def configure(self):
        ...
        self.bus.writeto(self.address, bytearray([self.config]))
    ...
    def convert(self):
        ...
        self.bus.writeto(self.address, bytearray([c]))

    def raw_read(self):
        res = self.get_resolution()
        bytes_to_read = 4 if res == 18 else 3
        bytes_to_read = bytearray(bytes_to_read)
        while True:

...
hyper_result_t hyper_device_13_encode(hyper_device_13_t * device, uint8_t * out, uint8_t * out_len) {
  ...
  if (device->raw_ph_adc_value_set) ++defined_attributes_count;
  if (device->raw_orp_adc_value_set) ++defined_attributes_count;
  if (device->raw_ec_adc_value_set) ++defined_attributes_count;
  if (device->water_temperature_set) ++defined_attributes_count;
...
// --- DISPATCH DEVICE ---
uint8_t hyper_device_13_dispatch(hyper_device_13_t * device) {
  uint8_t count = 0;
